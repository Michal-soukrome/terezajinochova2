...
export function AnimatedHeader({
  ...
  return (
    ...
    >
      <HeadingTag
        className="text-4xl md:text-5xl font-bold text-gray-900 font-heading mb-4"
      ...
      {showBadge && (
        <motion.div
          className="inline-flex items-center gap-2 px-4 py-2 bg-accent-1 border border-accent-1-contrast rounded-full"
