// Content copied from internal txt files (Czech)
...
const WHY_INTRO_CS = {
  ...
  description:
    "Tento deník ve velikosti A5 a s rozsáhlým obsahem (195 stran) vznikl s láskou k detailu a pochopením potřeb každé budoucí nevěsty. Pomůže vám přehledně zorganizovat všechny důležité informace – od prvních nápadů a inspirací přes výběr místa, dodavatelů, rozpočet až po harmonogram svatebního dne.",
  keepsake:
    "Svatební deník ale není jen praktickým nástrojem. Je to i krásná památka, do které si můžete vlepovat fotografie, zapisovat poznámky, vzpomínky a emoce. Po svatbě se tak promění v osobní knihu plnou momentů, ke kterým se budete rády vracet.",
};
...
const WHY_INTRO_EN = {
  ...
  description:
    "This A5-sized diary with extensive content (195 pages) was created with love for detail and understanding of every future bride's needs. It will help you clearly organize all important information – from first ideas and inspirations through venue selection, vendors, budget to the wedding day schedule.",
  keepsake:
    "But the Wedding Diary is not just a practical tool. It's also a beautiful keepsake where you can paste photos, write notes, memories, and emotions. After the wedding, it transforms into a personal book full of moments you'll love to revisit.",
};
